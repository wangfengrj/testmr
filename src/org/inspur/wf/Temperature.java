...
public class Temperature {
	...
	public static void main(String args[]) throws Exception {
		//配置hadoop_home环境变量，系统环境变量已设置
		System.setProperty("hadoop.home.dir", "F:\\eclipse\\hadoop-2.6.1");
		//设置日志文件log4j.properties
		String rootPath = System.getProperty("user.dir" );
		PropertyConfigurator.configure(rootPath+"\\src\\log4j.properties");
		// 输入路径
		String dst = "hdfs://10.110.20.183:8020/user/wf/input";
		// 输出路径，必须是不存在的，空文件加也不行。
		String dstOut = "hdfs://10.110.20.183:8020/user/wf/output";
